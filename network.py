...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nb_classes=101, channel=20):
        ...
        self.fc_feature = nn.Linear(512*block.expansion, 400)
        self.fc_custom = nn.Linear(400, nb_classes)
...
def resnet101(pretrained=False, channel= 20, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 23, 3],nb_classes=10, channel=channel, **kwargs)
    if pretrained:
