...
class Spatial_CNN():
    def __init__(self, nb_epochs, lr, batch_size, resume, start_epoch, evaluate, train_loader,
                 test_loader, test_video):
    ...
    #     index = 1
    #     label = torch.Tensor([37])
    #     path = 'D:\\Graduate\\ActionRecognition\\data\\ucf101\\try\\v_' + keys[0] + '\\'
    ...
    #     data_var.unsqueeze_(0)
    #     label_var.unsqueeze_(0)
    #     # compute output
    ...
    #     print(type(video_loss), video_loss, video_top1, video_top5)
    #     info = {'Epoch': [self.epoch],
    #             'Batch Time': [round(batch_time.avg, 3)],
