...
class Motion_DataLoader():
    ...
    def load_frame_count(self):
        ...
        with open(
                'D:\\Graduate\\ActionRecognition\\formers\\two-stream-action-recognition\\dataloader\\dic\\frame_count.pickle2',
                'rb') as file:
    ...
    def train(self):
        training_set = motion_dataset(dic=self.dic_video_train, in_channel=self.in_channel,
    ...
    def val(self):
        validation_set = motion_dataset(dic=self.dic_test_idx, in_channel=self.in_channel,
                                        root_dir=self.data_path,
                                        mode='val',
                                        transform=transforms.Compose([
                                            transforms.Scale([224, 224]),
